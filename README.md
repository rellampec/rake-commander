...
- It is possible to declare options as `required`
...
- Options parsing raises specific option errors. For a given task/class, each error type can have its own handler or preferred action.
